...
decl_module! {
	...
	pub struct Module<T: Trait> for enum Call where origin: T::Origin {
		...
		pub fn create_kitty(origin,owner: T::AccountId) -> Result {
			...
			let hash = (<system::Module<T>>::random_seed(), who.clone(), kitty_last_id).using_encoded(<T as system::Trait>::Hashing::hash);
      ...
      let dna = LittleEndian::read_u128(&hash[0..16]);
			...
			Self::deposit_event(RawEvent::KittyCreated(kitty_last_id,who,owner));
			Ok(())
		}
